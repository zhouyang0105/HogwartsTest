...
import com.hogwarts.service.wechat.apiobject.DepartMentObject;
import com.hogwarts.service.wechat.apiobject.TokenHelper;
import com.hogwarts.service.wechat.utils.FakerUtils;
...
//    @BeforeEach
    ...
    void listDepartment() {
        ...
        assertEquals("1",listResponse.path("errcode").toString()); //前面如果失败，后面不会执行，无法全部抛出问题，待优化。
